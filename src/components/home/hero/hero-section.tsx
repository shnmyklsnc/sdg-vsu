...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[100vh] overflow-hidden transition-all duration-300 lg:h-[85vh]">
      {/* Base Image */}
      <Image
      ...
      <div className="flex h-full flex-col justify-between lg:container lg:grid lg:grid-cols-[1fr_0.3fr]">
        <div className="mt-32 flex flex-col items-center justify-center px-4 text-center">
          <h1
            className="dark:text-secondary xs:text-4xl mb-3 text-3xl font-bold tracking-tight text-[#00954f] drop-shadow-[0_3px_10px_rgba(0,0,0,0.8)] md:text-6xl"

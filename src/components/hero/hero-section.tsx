      ...
      <div className="mt-32 flex h-full flex-col">
        <div className="flex flex-col items-center justify-center px-4 text-center">
          <div>
            <div className="mb-34">
              <h1
                className="text-primary dark:text-secondary mb-3 text-4xl font-bold tracking-tight drop-shadow-[0_3px_10px_rgba(255,255,255,1)] dark:drop-shadow-[0_3px_10px_rgba(0,0,0,0.5)]"
              ...
              >
                ...
                >
                  <div className="flex items-center px-2">
                    <span className="text-8xl font-bold tracking-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]">
                      G
                    </span>
